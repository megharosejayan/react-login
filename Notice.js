...
export default class Home extends React.Component{
    ...
    render(){
        ...
        return(
            ...
            <div>
                <h1>Thoughts</h1><br/>
               <RaisedButton label="SignOut" onClick={this.onSignout} style={{ float:"left", margin: 30, marginTop:5}}/> 
            </div>    
        ...
        <br />
        <TextField floatingLabelText="Content" onChange={this.onLast}/>
        </Dialog>
...
//        <Link to="/todo"><FlatButton label="Add Todo List"/></Link>
